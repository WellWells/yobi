...
- [截图预览](#-截图预览)
- [预构建下载](#-预构建下载)
- [AgentFlow](#-agentflow--可视化工作流自动化)
- [Telegram Bot](#-telegram-bot-集成)
- [设置与自定义](#%EF%B8%8F-设置与自定义)
- [DAC vs. 付费工具](#%EF%B8%8F-dac-vs-付费工具)
- [安全与隐私](#-安全与隐私)
- [开发指南](#%EF%B8%8F-开发指南)
- [参与贡献](#-参与贡献)
- [开源许可](#-开源许可)
...
| 主聊天界面 | 模型选择菜单 |
|:---:|:---:|
| ![主聊天界面](docs/assets/main-chat-interface.png) | ![模型选择菜单](docs/assets/model-selection-menu.png) |
| 与 AI 对话——无需 API Key | 在 ChatGPT · Gemini · Perplexity · Duck.ai 间切换 |

| 对话历史与摘要 | 导出选项 |
|:---:|:---:|
| ![对话历史摘要](docs/assets/chat-history-summary-result.png) | ![导出选项预览](docs/assets/export-options-preview.png) |
| 自动保存并附带时间戳 | 导出为 PNG、WebP 或 PDF，支持自定义样式 |

| 自定义回复设置 | Telegram Bot 配置 |
|:---:|:---:|
| ![自定义回复设置](docs/assets/settings-custom-your-own-response.png) | ![Telegram Bot 配置](docs/assets/settings-telegram-bot-config.png) |
