      ...
      {value.type === 'cron' && (
        <Stack gap="xs">
          <AppSegmentedControl
            value={scheduleMode}
            options={[
              { value: 'weekly', label: t('flow.trigger.schedule.mode.weekly') },
              { value: 'interval', label: t('flow.trigger.schedule.mode.interval') },
            ]}
          ...
          {scheduleMode === 'interval' && (
            <Stack gap="sm" p="sm" style={INLINE_CARD}>
              <Group gap="xs" align="center" wrap="nowrap">
                <Text fz="sm" fw={600} miw={86}>{t('flow.trigger.schedule.runEvery')}</Text>
                <AppNumberInput
          ...
          <Stack gap="sm" p="sm" style={INLINE_CARD}>
            ...
            <Group gap="xs" align="center" wrap="nowrap">
              <Text fz="sm" fw={600} miw={86}>{t('flow.trigger.schedule.startTime')}</Text>
              <SelectDropdown
                aria-label={t('flow.trigger.schedule.hour')}
                options={hourOptions}
              ...
              <SelectDropdown
                aria-label={t('flow.trigger.schedule.minute')}
            ...
            {repeatWithinDay && (
              <Stack gap="xs">
                <Group gap="xs" align="center" wrap="nowrap">
                  <Text fz="sm" fw={600} miw={86}>{t('flow.trigger.schedule.repeatEvery')}</Text>
                  <AppNumberInput
                ...
                <Group gap="xs" align="center" wrap="nowrap">
                  <Text fz="sm" fw={600} miw={86}>{t('flow.trigger.schedule.endTime')}</Text>
                  <SelectDropdown
                    aria-label={t('flow.trigger.schedule.hour')}
                    options={hourOptions}
                ...
                {endTimeInvalid && (
                  <Group gap={6} align="center">
                    ...
                    <Text fz="xs" c="orange">{t('flow.trigger.schedule.endTimeWarning')}</Text>
                  </Group>
                )}
              </Stack>
            )}
