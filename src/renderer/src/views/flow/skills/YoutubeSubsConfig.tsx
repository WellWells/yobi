...
export const YoutubeSubsConfig: React.FC<SkillConfigProps> = ({ step, onChange, t }) => {
  ...
  return (
    <Stack gap="xs">
      <AppTextarea
        label={t('flow.skill.youtube_subs.channels')}
        placeholder={t('flow.skill.youtube_subs.channels.placeholder')}
        value={channels}
        ...
        resize="vertical"
        mono
        error={channelsError ? t('flow.skill.youtube_subs.channels.error') : undefined}
      />

      <Text fz="xs" c="dimmed">
        {t('flow.skill.youtube_subs.channels.hint')}
      </Text>

      <AppNumberInput
        label={t('flow.skill.youtube_subs.perChannel')}
        value={perChannel}
      ...
      <SettingRow
        ...
        label={t('flow.skill.youtube_subs.skipShorts')}
        hint={t('flow.skill.youtube_subs.skipShorts.hint')}
        control={
          <ToggleSwitch
            checked={skipShorts}
      ...
      <Text fz="xs" c="dimmed">
        {t('flow.skill.youtube_subs.hint')}
      </Text>
      ...
      {hasCheckpoint && (
        <Group gap="xs" align="center">
          <Badge
            ...
            radius="sm"
          >
            {t('flow.skill.youtube_subs.stateActive')}
          </Badge>
        </Group>
      )}
      ...
      >
        {t('flow.skill.youtube_subs.clearState')}
      </Button>
